...
export default Ember.Component.extend({
  ...
  census: Ember.computed(function() {
    ...
    return Ember.$.getJSON(url).then(function(responseJSON) {
      ...
      var url2 = 'http://api.census.gov/data/2015/pdb/tract?get=Tot_Population_CEN_2010,pct_Females_CEN_2010,pct_Males_CEN_2010,pct_College_ACS_09_13,Med_HHD_Inc_ACS_09_13,Prs_Blw_Pov_Lev_ACS_09_13&for=tract:' + tract + '&in=state:41+county:051&key=d90ad8655f9cb4d3ee0909e5831a4989a51a22ab';
